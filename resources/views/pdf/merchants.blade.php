    ...
    <div>
        <table>
            ...
            <tr style="color: black; text-align: center; background-color: #FFFFFF; border: 1px solid #FFFFFF;">
                <th style="text-align: left; font-size: 11px;" colspan="3">Reporte de empresarios - {{time()}}</th>
            ...
            @foreach($merchants as $merchant)
                <tr @if($merchant->status=="inactivo") style="background-color: #fab4b1" @endif >
                    <td>{{$contador}}</td>
                     <td>
                        {{$merchant->ci}}
                    </td>
                    <td>
                        {{$merchant->last_name}}  {{$merchant->name}}
                    </td>
                    <td>
                        {{$merchant->address}}
                    </td>
                    ...
                    <td>
                        ...
                        {{\Carbon\Carbon::parse($merchant->created_at)->toFormattedDateString()}}
                    </td>
