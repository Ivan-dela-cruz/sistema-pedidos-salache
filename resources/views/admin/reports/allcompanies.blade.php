...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            {!! Form::open(['route' => 'get-report-all-orders', 'method'=>'GET','autocomplete'=>'off','role'=>'search']) !!}
            <div class="row">
                    ...
                    <div class="ibox-body">
                        <div class="ibox-tools">
                                <h5 class="d-none d-lg-block inbox-title">
                                    {!! Form::open(['route' => 'get-pdf-report-all-orders', 'method'=>'GET','autocomplete'=>'off','role'=>'search']) !!}
                                        <input value="@if(isset($request_year)){{$request_month}}@endif"  type="text" name="month" id="month_id">
                                        <input value="@if(isset($request_year)){{$request_year}}@endif"  type="text" name="year" id="year_id">
                                        <input  type="text" name="company" id="company_id">
